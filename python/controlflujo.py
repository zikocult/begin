...
print("cuando devuelve true") if 5 < 2 else print("cuando devuelve false") # Operador ternari 

# Us del and i el or
if 2 < 5 and 3 > 2:
    print ("les dos tornen true")
else: print ("aquest no s'imprimeix")

if 2 < 5 and 3 < 2:
    print ("les dos tornen true")
else: print ("aquest si s'imprimeix") # Amb l'operador and, les dues condicions han de ser true

if 2 < 5 or 3 < 2:
    print ("Alguna de les condicions es true")
else: print ("aquest no s'imprimeix") # Amb l'operador or, si una de les condicions es true complirà l'if, per a passar a else, tindria que tenir dos false