# Adjunto aquí el que hi ha moulos.py, d'aquesta manera no haig d'anar
# entrant i sortint per a revisar
...
# Podem renombrar el nom del fitxer per a no fer la crida amb el nom del fitxer
