...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   10-countingelements.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gbaruls- <gbaruls->                        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/24 12:29:17 by gbaruls-          #+#    #+#             */
/*   Updated: 2024/07/30 19:09:21 by Guillem Barulls  ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char *argv[])
{
	...
	printf("Linked list iterative has %d elements\n", iterative_count(root));
	printf("Linked list recursive has %d elements\n", recursive_count(root));
	deallocate(&root);	
	return (0);
}
